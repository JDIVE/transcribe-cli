...
- `transcribe-cli-v0.1.0-linux-x64-baseline`
- `transcribe-cli-v0.1.0-linux-arm64`
- `transcribe-cli-v0.1.0-darwin-x64`
- `transcribe-cli-v0.1.0-darwin-arm64`
- `transcribe-cli-v0.1.0-windows-x64-baseline.exe`
